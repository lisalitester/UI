...
class DesignList(ParametrizedTestCase):
    ...
    #
    # @get_url(designList_url)
    # def test_a420_designList_flow_step_clear(self):
    ...
    #
    # @get_url(designList_url)
    # def test_a421_designList_flow_step_back(self):
    ...
    #
    # @get_url(designList_url)
    # def test_a422_designList_flow_step_reset(self):
    ...
    # @get_url(designList_url)
    # def test_a490_designList_flow_step_schedule(self):
...
#========================================= stream start ========================================================================================
    ...
    #     app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-aggregate-step-提交.yaml"),
    #            "caseName": sys._getframe().f_code.co_name}
    #     page = DesignListPage(app)
    #     page.operate()
    #     page.check_point()
    ...
    #     app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-filter-step-提交.yaml"),
    #            "caseName": sys._getframe().f_code.co_name}
    #     page = DesignListPage(app)
    #     page.operate()
    #     page.check_point()
    ...
    #     app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-interval_filter-step-提交.yaml"),
    #            "caseName": sys._getframe().f_code.co_name}
    #     page = DesignListPage(app)
    #     page.operate()
    #     page.check_point()
    ...
    #     app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-join-step-提交.yaml"),
    #            "caseName": sys._getframe().f_code.co_name}
    #     page = DesignListPage(app)
    #     page.operate()
    #     page.check_point()
    ...
    #     app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-merge-step-提交.yaml"),
    #            "caseName": sys._getframe().f_code.co_name}
    #     page = DesignListPage(app)
    #     page.operate()
    #     page.check_point()
    ...
    #     app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-split-step-提交.yaml"),
    #            "caseName": sys._getframe().f_code.co_name}
    #     page = DesignListPage(app)
    #     page.operate()
    #     page.check_point()
    ...
    #     app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-sql-step-提交.yaml"),
    #            "caseName": sys._getframe().f_code.co_name}
    #     page = DesignListPage(app)
    #     page.operate()
    #     page.check_point()
    ...
    #     app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-watermark-transform-step-提交.yaml"),
    #            "caseName": sys._getframe().f_code.co_name}
    #     page = DesignListPage(app)
    #     page.operate()
    #     page.check_point()
    ...
    #     app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-sink-hbase-单列族.yaml"),
    #            "caseName": sys._getframe().f_code.co_name}
    #     page = DesignListPage(app)
    #     page.operate()
    #     page.check_point()
    ...
    #     app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-sink-hbase-单列族-查看运行结果.yaml"),
    #            "caseName": sys._getframe().f_code.co_name}
    #     page = DesignListPage(app)
    #     page.operate()
    #     page.check_point()
    ...
    #     app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-sink-hbase-多列族.yaml"),
    #            "caseName": sys._getframe().f_code.co_name}
    #     page = DesignListPage(app)
    #     page.operate()
    #     page.check_point()
    ...
    #     app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-sink-hbase-多列族-查看运行结果.yaml"),
    #            "caseName": sys._getframe().f_code.co_name}
    #     page = DesignListPage(app)
    #     page.operate()
    #     page.check_point()
    ...
    @get_url(designList_url)
    def test_a544_rtcflow_sink_hbase(self):
        app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-sink-redis.yaml"),
               "caseName": sys._getframe().f_code.co_name}
        page = DesignListPage(app)
        page.operate()
        page.check_point()
    ...
    def test_a545_rtcflow_sink_redis_view_result(self):
        app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../../YAML/designList_yaml/rtcflow_yaml/rtcflow-sink-redis-查看运行结果.yaml"),
               "caseName": sys._getframe().f_code.co_name}
        page = DesignListPage(app)
        page.operate()
        page.check_point()
